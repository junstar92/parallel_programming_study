/*****************************************************************************
 * File:        09_omp_odd_even2.c
 * Purpose:     Use odd-even transposition sort to sort a list of ints.
 *              This version forks and joins the threads only once.
 * Compile:     gcc -Wall -fopenmp -o 09_omp_odd_even2 09_omp_odd_even2.c
 * Run:         ./09_omp_odd_even2 <number of threads> <n> <g|i>
