 ...
 *              This version accepts input of the endpoints of the interval and
 *              the number of trapezoids.
 * Compile:     mpicc -Wall -o 04_mpi_trap2 04_mpi_trap2.c
 * Run:         mpiexec -n <number of proesses> ./04_mpi_trap2
 * 
 * Algorithm:
