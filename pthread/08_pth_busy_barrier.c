/*****************************************************************************
 * File:        08_pth_busy_barrier.c
 * Purpose:     Use busy-waiting and mutex barriers to synchronize threads
 * 
 * Compile:     gcc -Wall -o 08_pth_busy_barrier 08_pth_busy_barrier.c -pthread
 *              [-DDEBUG]
 * Run:         ./08_pth_busy_barrier <number of threads>
 * 
 * Input:       none
