/*****************************************************************************
 * File:        03_pth_pi_busy1.c
 * Purpose:     Estimate pi using serise
 * 
 *                  pi = 4*[1 - 1/3 + 1/5 - 1/7 + 1/9 - . . .]
 *              
 *              This version uses busy-waiting to control access to the
 *              critical section.
 * 
 * Compile:     gcc -Wall -o 03_pth_pi_busy1 03_pth_pi_busy1.c -pthread [-lm]
 * Run:         ./03_pth_pi_busy1 <number of threads> <n>
